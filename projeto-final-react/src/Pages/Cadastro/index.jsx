...
export const CadastroUser = () => {
  ...
  const handleShowCadastroEfetuado = () => setShowCadastroEfetuado(true);
  const [showCadastroEfetuado, setShowCadastroEfetuado] = useState(false);
  const handleCloseCadastroFail = () => setShowCadastroEfetuado(false);
  const handleShowCadastroEFail = () => setShowCadastroEfetuado(true);
  ...
  function ChangeShowModalCadastroEfetuado() {
    if (showCadastroEfetuado) {
      setShowCadastroEfetuado(false);
    } else {
      setShowCadastroEfetuado(true);
    }
  }
        ...
        <div className="ContainerLogin">
          <div className="ContainerCadastroHolder">
            ...
            <div className="BottomContainerLogin">
              <Button style={{width:"50%", fontWeight: "bold", color: "white" }} onClick={() => handleSubmit()}>Cadastrar</Button>
            </div>
          </div>
        </div>
      </div>
